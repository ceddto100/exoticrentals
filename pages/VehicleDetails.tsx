        ...
        <div className="lg:col-span-2 space-y-10">
          ...
          <section className="bg-blue-50 p-6 rounded-xl border border-blue-100">
            <h3 className="flex items-center text-lg font-bold text-blue-900 mb-2">
              <Shield className="h-5 w-5 mr-2" /> Insurance & Protection
            </h3>
            ...
            <div className="flex gap-4 text-sm text-blue-700">
              <span className="flex items-center"><Check className="h-4 w-4 mr-1" /> 24/7 Roadside Assist</span>
              <span className="flex items-center"><Check className="h-4 w-4 mr-1" /> Theft Protection</span>
            </div>
          </section>
          ...
          <div className="bg-white p-6 rounded-2xl shadow-xl border border-gray-200 sticky top-24">
            <div className="flex justify-between items-end mb-6">
              ...
              <div className="text-right">
                <p className="text-sm text-green-600 font-medium bg-green-50 px-2 py-1 rounded">Available Now</p>
              </div>
            </div>
            ...
            <div className="space-y-4 mb-6">
              ...
              <div>
               ...
               <div>
                ...
                <div className="relative">
                  <select className="block w-full pl-10 pr-3 py-2 border border-gray-300 rounded-lg focus:ring-indigo-500 focus:border-indigo-500 bg-white">
            ...
            <button 
              ...
              className="w-full bg-indigo-600 text-white py-3 px-4 rounded-xl font-bold hover:bg-indigo-700 transition shadow-lg hover:shadow-indigo-500/30 disabled:bg-gray-400 disabled:cursor-not-allowed"
            >
